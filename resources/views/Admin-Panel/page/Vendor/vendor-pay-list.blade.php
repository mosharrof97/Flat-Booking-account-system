                                        ...
                                        <tbody>
                                            @foreach ($pay as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <font color="blue">{{ $data->bank_name == null ? '---' : $data->bank_name }}</font>
                                                    </td>
                                                    <td>
                                                        <font color="blue">{{ $data->account_number == null ? '---' : $data->account_number }}</font>
                                                    </td>
                                                    <td>
                                                        <font color="blue">{{ $data->check_number == null ? '---' : $data->check_number }}</font>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="action">
                                                        <a href="{{ route('vendor.purchase.invoice',$data->id) }}"  class="btn btn-light" style="background-color: #0ca080 !important;">view</i></a>
                                                        <a href="{{ route('vendor.pay.data.delete',$data->id) }}"  class="btn btn-danger" style="background-color: #fa5d35 !important;"><i class="fa-solid fa-trash"></i></a>
                                                    </td> 
                                                </tr>
                                            @endforeach
