                    ...
                    <form class="" action="{{ route('store.vendor.purchase.due.pay', $vendor->id) }}" method="POST"
                        ...
                        <div class="mt-3 " id="bank_details" style="display: none">
                            ...
                            <div class="form-inline row g-3">
                                ...
                                <div class="form-group col-md-6" id="account_number_div">
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label for="account_number"
                                                class="col-sm-4 col-form-label text-right bg-info">Account
                                                Number</label>
    ...
    <script>
        $(document).on('change', '#payment_type', function() {
            ...
            if (payment_type == 'check') {
                ...
                $('#account_number_div').css('display', 'none');
            } else if (payment_type == 'bank') {
                $('#check_number_div').css('display', 'none');
                $('#account_number_div').css('display', 'block');
            }
        })
    </script>
@endsection
