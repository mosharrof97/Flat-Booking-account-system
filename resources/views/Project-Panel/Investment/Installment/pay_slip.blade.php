        ...
        <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 padding">
            <div class="card" id="printArea">
                <div class="card-header flex-column justify-content-center p-4">
                    ...
                    <center>
                        <h3 class="mb-0"><b><u>Pay Slip</u></b></h3>
                    </center>
                </div>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            @php
                                $address =$investment->client->clientAddress;
                            @endphp
                        ...
                        <div class="col-sm-6 " style="text-align: end">
                            ...
                            <div style=" font-size: 17px; font-weight: 700; color:#000; ">Payment No:{{ $installment->id + 500 }}</div>
                            <div style=" font-size: 17px; font-weight: 700; color:#000; ">Biller by: {{ $investment->user->name }}</div>
                        </div>
                    </div>
